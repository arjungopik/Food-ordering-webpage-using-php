                        ...
                        <div id="slider" class="carousel slide w-100" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img src="images/slide1.jpg" class="slider-img">
                                </div>
                                <div class="carousel-item">
                                    <img src="images/slide2.jpeg" class="slider-img">
                                </div>
                                <div class="carousel-item">
                                    <img src="images/slide3.jpeg" class="slider-img">
                                </div>
                            </div>
                                        ...
                                        <div class="col-12 bg-white text-center h-100 product-item">
                                            <div class="row h-100">
                                                <div class="col-12 p-0 mb-3">
                                                        ...
                                                        <img src="images/TIKKA.jpg" class="img-fluid">
                                                    </a>
                                                </div>
                                                <div class="col-12 mb-3">
                                                    CHICKEN TIKKA
                                        ...
                                        <div class="col-12 bg-white text-center h-100 product-item">
                                            ...
                                            <div class="row h-100">
                                                <div class="col-12 p-0 mb-3">
                                                        ...
                                                        <img src="images/BIRIYANI.jpg" class="img-fluid">
                                                    </a>
                                                </div>
                                                <div class="col-12 mb-3">
                                                    CHICKEN BIRIYANI
